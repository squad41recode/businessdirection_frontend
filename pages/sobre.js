...
const Sobre = () => {
  ...
  <article className="container row mt-0">
    <div className="col-12 col-lg-6 m-auto">
      <h2>Nossa missão</h2>
      <p>
        A Business Direction é uma empresa social que tem como objetivo auxiliar
        pessoas de baixa renda, com interesse em empreendedorismo e crescimento
        econômico, a identificar suas necessidades como empreendedor, os
        recursos necessários, fontes de financiamento que melhor se adequam a
        sua realidade, desenvolver plano de negócio, desenvolver plano de
        marketing, entre outras orientações.
      </p>
    </div>
    <div className=" col-12 col-lg-5" id=" ">
      <div className="img-sn">
        <img src="../img/sobrenos/img-1.png" alt="img" className="img-fluid" />
      </div>
    </div>
  </article>
  {/* nossa historia */}
  <article className="container row mt-5">
    <div className="col-12 col-lg-6 order-lg-last m-auto">
      ...
      <p>
        A Business Direction é uma organização que nasceu da necessidade de
        auxiliar pessoas de baixa renda a desenvolver suas ideias e realizar
        seus sonhos oferecendo mentorias completas para auxiliar desde a
        descoberta do projeto potencial, passando pela identificação das
        melhores fontes financiadoras, menores taxas de juros, até a devida
    ...
    <div className=" col-12 col-lg-5" id=" ">
      <div className="img-sn">
        <img src="../img/sobrenos/img-2.png" alt="img" className="img-fluid" />
      </div>
    </div>
  </article>
